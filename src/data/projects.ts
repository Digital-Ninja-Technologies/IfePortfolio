...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: "Crypto Wallet · GameFi",
    categories: ["Web3 & Crypto", "Fintech & Payments"],
    description: "A specialized crypto wallet landing page designed for gamers and esports enthusiasts. Features gaming rewards integration, NFT management, and seamless DeFi access tailored for the gaming ecosystem with transparent security.",
    tags: ["Product Designer", "2025", "Figma & Webflow"],
