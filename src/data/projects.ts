...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: "Web3 · Gaming",
    categories: ["Web3 & Crypto", "Websites & Landing Pages"],
    description: "Designing a conversion-focused landing page for GamersWallet — a cutting-edge platform that allows gamers to convert in-game achievements and virtual currency into real-world value.",
    tags: ["Lead Product Designer", "2024", "Figma & Photoshop"],
    ...
    bgColor: "hsl(250 50% 95%)",
    liveUrl: "https://contra.com/p/PWBFMY3e-sportrex-gamers-wallet-landing-page?r=designninja",
  },
  {
